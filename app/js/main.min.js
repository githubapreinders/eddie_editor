...
(function ()
{
    ...
    angular.module('confab')
        .controller('IndexController', ["xmlTag", "staticDataFactory", function (xmlTag, staticDataFactory)
        {
            ...
            vm.editoroptions = { 
                                    ...
                                    mode : 'xml',
                                    theme:'twilight',
                                    value:"<html style='color: green'>\n<!-- this is a comment -->\n<head>\n<title>HTML Example</title>\n</head>\n<body>\nThe indentation tries to be .... but might not match your style.\n</body>\n</html>"
                                }
            ...
            function codemirrorLoaded(_editor)
            {
                ...
                _doc.markClean();
                _doc.setValue("<html style='color: green'>\n<!-- this is a comment -->\n<head>\n<title>HTML Example</title>\n</head>\n<body>\nThe indentation tries to be .... but might not match your style.\n</body>\n</html>");
...
angular.module('confab')
    ...
    .service('staticDataFactory', ["xmlTag", function(xmlTag) 
    {
